...
<h5>Quick links</h5>
        <ul class="list-footermenu">
          <li><a href="<?=site_url('../home/about');?>" title="About Us">About us</a></li>
          <li><a href="<?=site_url('../blog');?>" title="Blog"><span>Blog</span></a></li>
          <li><a href="<?=site_url('../home/faq');?>" title="Product Help">Product Help</a></li>
          <li><a href="<?=site_url('../home/contact');?>" title="Contact Us">Contact Us</a></li>
          <li><a href="<?=site_url('../home/privacy');?>" title="Privacy">Privacy</a></li>
          <li><a href="<?=site_url('../home/tos');?>" title="Terms of Service">Terms of Service</a></li>
          <li><a href="<?=site_url('home/refund_policy');?>" title="Refund Policy">Refund Policy</a></li>
        </ul>
			</div>
		</div>
	</div>
...
<script type="text/javascript" language="javascript">
    ...
    TrustLogo("https://legendrepricing.com//asset/images_d/comodo_secure_113x59_transp.png", "CL1", "bottomright");
    </script>
