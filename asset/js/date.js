...
DateInput.prototype = {
  build: function() {
    var monthNav = $('<p class="month_nav">' +
      '<span class="button_cal prev" title="[Page-Up]">&#171;</span>' +
      ' <span class="month_name"></span> ' +
      '<span class="button_cal next" title="[Page-Down]">&#187;</span>' +
      '</p>');
    ...
    var yearNav = $('<p class="year_nav">' +
      '<span class="button_cal prev" title="[Ctrl+Page-Up]">&#171;</span>' +
      ' <span class="year_name"></span> ' +
      '<span class="button_cal next" title="[Ctrl+Page-Down]">&#187;</span>' +
      '</p>');
    ...
    if ($.browser.msie && $.browser.version < 7) {
      ...
      $(".button_cal", nav).mouseover(function() { $(this).addClass("hover") });
      $(".button_cal", nav).mouseout(function() { $(this).removeClass("hover") });
    };
