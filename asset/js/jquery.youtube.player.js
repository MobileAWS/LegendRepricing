...
(function($, window, document, undefined){
	...
	player.prototype = {
		...
		_createTimeArea : function(){
			...
			this.elements.toolbar.timeCurrent = $('<span id="current_time"/>').html('0:00').appendTo(this.elements.toolbar.time);
			this.elements.toolbar.timeDuration = $('<span id="duration_time"/>').appendTo(this.elements.toolbar.time);
