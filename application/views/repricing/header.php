...
<script type="text/javascript" language="javascript" src="<?=base_url();?>asset/js/jquery.tablesorter.js"></script>
<script type="text/javascript" language="javascript" src="<?=base_url();?>asset/js_d/md5.js"></script>
