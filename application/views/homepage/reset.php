            ...
            <div class="panel-body">
              <div class="text-center">
                ...
                <div class="panel-body">
                  ...
                  <form class="form" id="reset_password" action="#" method="post"><!--start form--><!--add form action as needed-->
                    <fieldset>
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input type="password" name="password" class="form-control" id="npassword" placeholder="Enter password" required>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-unlock-alt"></i></span>
                          <input type="password" name="cpassword" class="form-control" id="cpassword" placeholder="Enter again password" required>
                          <input type="hidden" name="key" class="form-control" id="key" value="<?php echo $key;?>" >
                        </div>
                        <div class="help-block with-errors"></div>
                      </div>
                      ...
                      <div class="form-group">
                        <input class="btn btn-lg btn-primary btn-block" value="Send My Password" type="button" id="send_reset">
                      </div>
                    </fieldset>
                  </form><!--/end form-->
