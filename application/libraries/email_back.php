...
class CI_Email {
	...
	var	$smtp_host		= "mail.techvillagebd.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "techvill";		// SMTP Username
	var	$smtp_pass		= "g^vEezVJ;4UN";		// SMTP Password
